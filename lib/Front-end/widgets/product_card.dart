                  ...
                  if (stockQuantity != null)
                    Text(
                      stockQuantity! > 0
                          ...
                          : 'Out of stock',
                      style: TextStyle(
                        fontSize: AppDimensions.smallFont(context) * 0.9,
                        color: stockQuantity! > 0
                            ? (stockQuantity! <= 5 ? Colors.orange : Colors.green[700])
                            : Colors.red,
                        fontWeight: stockQuantity! <= 5 ? FontWeight.w600 : FontWeight.normal,
                      ),
                    ),
