...
- [x] 3. Fix for invalid JSON response in product upload with image

  - [x] 3.1 Implement backend output buffer cleaning in products.php
  ...
  - [x] 3.2 Update jsonResponse and errorResponse helpers in bootstrap.php
  ...
  - [x] 3.3 Verify and remove PHP closing tags
  ...
  - [x] 3.4 Add response validation in products.php
  ...
  - [x] 3.5 Improve frontend response validation in api_service.dart
